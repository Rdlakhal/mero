...
def Tele(ccx):
    ...
    'priority': 'u=0, i',
    'referer': 'https://www.luxjunaturalhairproducts.com/',
	...
	response = r.get('https://www.luxjunaturalhairproducts.com/my-account/', headers=headers)
    ...
    'origin': 'https://www.luxjunaturalhairproducts.com',
    'priority': 'u=0, i',
    'referer': 'https://www.luxjunaturalhairproducts.com/my-account/',
    'sec-ch-ua': '"Chromium";v="128", "Not;A=Brand";v="24", "Google Chrome";v="128"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-platform': '"Windows"',
    'sec-fetch-dest': 'document',
    ...
    'wc_order_attribution_session_entry': 'https://www.luxjunaturalhairproducts.com/',
    'wc_order_attribution_session_start_time': '2024-08-22 15:06:18',
	...
	response = r.post('https://www.luxjunaturalhairproducts.com/my-account/', headers=headers, data=data)
	
	headers = {
	    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'priority': 'u=0, i',
    'referer': 'https://www.luxjunaturalhairproducts.com/my-account/edit-address/',
    'sec-ch-ua': '"Chromium";v="128", "Not;A=Brand";v="24", "Google Chrome";v="128"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-platform': '"Windows"',
    'sec-fetch-dest': 'document',
	...
	response = r.get('https://www.luxjunaturalhairproducts.com/my-account/edit-address/billing/', cookies=r.cookies, headers=headers)
    ...
    'origin': 'https://www.luxjunaturalhairproducts.com',
    'priority': 'u=0, i',
    'referer': 'https://www.luxjunaturalhairproducts.com/my-account/edit-address/billing/',
    'sec-ch-ua': '"Chromium";v="128", "Not;A=Brand";v="24", "Google Chrome";v="128"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-platform': '"Windows"',
    'sec-fetch-dest': 'document',
	...
	response = r.post('https://www.luxjunaturalhairproducts.com/my-account/edit-address/billing/', cookies=r.cookies, headers=headers, data=data)
    ...
    'accept-language': 'en-US,en;q=0.9',
    'priority': 'u=0, i',
    'referer': 'https://www.luxjunaturalhairproducts.com/my-account/payment-methods/',
    'sec-ch-ua': '"Chromium";v="128", "Not;A=Brand";v="24", "Google Chrome";v="128"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-platform': '"Windows"',
    'sec-fetch-dest': 'document',
	...
	response = r.get('https://www.luxjunaturalhairproducts.com/my-account/add-payment-method/', cookies=r.cookies, headers=headers)
    ...
    'origin': 'https://www.luxjunaturalhairproducts.com',
    'priority': 'u=1, i',
    'referer': 'https://www.luxjunaturalhairproducts.com/my-account/add-payment-method/',
    'sec-ch-ua': '"Chromium";v="128", "Not;A=Brand";v="24", "Google Chrome";v="128"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-platform': '"Windows"',
	...
	response = r.post('https://www.luxjunaturalhairproducts.com/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data)
	...
	json_data = {
        ...
        'source': 'client',
        'integration': 'custom',
        'sessionId': 'de75b74e-dbb6-4a5a-85b0-cf009053a99b',
    },
    ...
    ('wc_braintree_device_data', '{"correlation_id":"efbffde4d8bfa9951aeb72f2358af028"}'),
	...
	response = r.post('https://www.luxjunaturalhairproducts.com/my-account/add-payment-method/', cookies=r.cookies, headers=headers, data=data)
